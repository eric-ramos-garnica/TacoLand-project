...
function initMap() {
  ...
  var infoWindow = new google.maps.InfoWindow({
      content:`<a href="#"><h2 style="color: rgb(235,107,60); font-family: 'Titan One', cursive; text-decoration: underline;">${business_name}</h2></a><h2>Hours:${hr}<h2><h2>Rating:${rating}</h2>`
    });
