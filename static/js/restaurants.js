...
mex_restaurants_array.forEach((coord,i) => {
    ...
    content: `<a href="/restaurantInfo/${vendor_ids_array[i]}"><h2 style="color: rgb(235,107,60); font-family: 'Titan One', cursive; text-decoration: underline;">${business_title_array[i]}</h2></a><h2>Phone:${phones_array[i]}</h2>`
    });
